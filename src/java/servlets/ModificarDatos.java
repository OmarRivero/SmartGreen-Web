...
public class ModificarDatos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String correoAnte = request.getParameter("correoAnte");
        ...
        if(correoAnte.equals(correo)){            
            conexion.modificarUser(correoAnte, nombre, correo, contra);
        }
        else{
            if(!existe){
                conexion.modificarUser(correoAnte, nombre, correo, contra);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<body id=\"page-top\" class=\"index\">"
                    ...
                    if(!existe){
                        ...
                        out.println("           <h3 class=\"section-subheading text-muted\">Tus datos han sido modificados exitosamente ;)</h3>");
                    }
                    else{
