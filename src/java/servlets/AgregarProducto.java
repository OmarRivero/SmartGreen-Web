...
public class AgregarProducto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String a = request.getParameter("nombreProducto");
        String b = request.getParameter("precio");
        String c = request.getParameter("cantidad");
        String d = request.getParameter("descripcion");
        String e = request.getParameter("imagen");

        Acceso j = new Acceso();
        
        try (PrintWriter out = response.getWriter()) {
            j.AgregarProducto(a, b, c, d, e);
            ...
            out.println("<body id=\"page-top\" class=\"index\">"
                    ...
                    + "                        <h2 class=\"section-heading\">Perfecto!</h2>\n"
                    + "                        <h3 class=\"section-subheading text-muted \">El nuevo producto ha sido agregado con éxito.</h3>\n"
                    + "                    </div>\n"
                    + "                </div>\n"
                    + "            </div>\n"
                    + "             <div class=\"row\">\n"
