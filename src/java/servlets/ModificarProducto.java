...
public class ModificarProducto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String nombreAnte = request.getParameter("nombreProductoAnterior");
        ...
        conexion.modificarProducto(nombreAnte, nombre, precio, cantidad, descripcion, imagen);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<body id=\"page-top\" class=\"index\">"
                    ...
                    + "                        <h2 class=\"section-heading\">Muy bien!</h2>\n"
                    + "                        <h3 class=\"section-subheading text-muted \">Los datos han sido actualizados</h3>\n"
                    + "                    </div>\n"
                    + "                </div>\n"
                    + "            </div>\n"
                    + "             <div class=\"row\">\n"
